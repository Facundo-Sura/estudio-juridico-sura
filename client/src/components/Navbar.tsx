  ...
  return (
    <nav className="bg-white text-black flex flex-row justify-evenly justify-items-center items-center">
      ...
      <menu>
        ...
        <button className="hover:bg-gradient-to-r from-fuchsia-700 via-red-500 to-orange-600 hover:text-white rounded-md m-1 p-1 w-36 h-14">SERVICIOS</button>
        <button className="hover:bg-gradient-to-r from-fuchsia-700 via-red-500 to-orange-600 hover:text-white rounded-md m-1 p-1 w-36 h-14">AGENDA</button>
