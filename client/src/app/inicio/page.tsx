    ...
    <div className="relative">
      ...
      <div className="relative z-10 p-8">
        <div>
          ...
          <h2 className="text-center font-bold text-2xl font-sans m-2 p-2">
          ...
          <div className="my-4 p-1 text-center">
            <Link
              href="/nosotros"
              className="border-2 border-solid border-black p-5 hover:translate-x-6 hover:bg-slate-400 hover:bg-opacity-20 hover:underline"
            >
              Saber mas
            </Link>
          </div>
          ...
          <h3 className="bg-black bg-opacity-50 border-2 py-4 text-4xl relative  group-hover:opacity-0 transition-opacity duration-1000">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 m-2 flex flex-col items-center justify-center transition-all duration-1000 opacity-0 translate-y-full group-hover:translate-y-0 group-hover:opacity-100 z-10">
                ...
                <div className="p-5 text-center">
                  <Link
                    href="/servicios"
                    className="border-2 border-solid border-white p-3 hover:bg-slate-400 hover:bg-opacity-30"
                  >
                    Saber mas
                  </Link>
                </div>
